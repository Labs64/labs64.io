...
<div class="row">
    <div class="col-md-12 NL_form_light NL_block">
        <div class="col-md-8 col-md-offset-2 NL_form_light_text">
            ...
            <span>Run AuditFlow locally as part of the guided onboarding path.</span>
            <a href="{{ '/get-started/' | relative_url }}" class="NL_button button_main NL_dark_btn NL_wide_btn">
                Get started
            </a>
            {%- assign m = site.data.modules | where: "id", "auditflow" | first -%}
            <p><a href="{{ m.repo }}">View the AuditFlow repository</a></p>
        </div>
    </div>
</div>
