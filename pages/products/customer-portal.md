...
<div class="row">
    <div class="col-md-12 NL_form_light NL_block">
        <div class="col-md-8 col-md-offset-2 NL_form_light_text">
            ...
            <span>Run Customer Portal locally as part of the guided onboarding path.</span>
            <a href="/docs/getting-started/" class="NL_button button_main NL_dark_btn NL_wide_btn NL_cta_btn">
                Get started
            </a>
            {%- assign m = site.data.modules | where: "id", "customer-portal" | first -%}
            <p><a href="{{ m.repo }}">View the Customer Portal repository</a></p>
        </div>
    </div>
</div>
